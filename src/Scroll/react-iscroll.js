...
var ReactIScroll = (function(_React$Component) {
  ...
  function ReactIScroll(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (ReactIScroll.__proto__ || Object.getPrototypeOf(ReactIScroll)).call(this, props),
    );
  ...
  _createClass(ReactIScroll, [
    ...
    },
    {
      ...
      value: function shouldComponentUpdate(nextProps, nextContext) {
        return (
          !(0, _deepEqual2.default)(this.props, nextProps) ||
          !(0, _deepEqual2.default)(this.context, nextContext)
        );
      },
      ...
      value: function _updateIScrollEvents(prevProps, nextProps) {
        for (var _reactEventName in availableEventNames) {
          this._updateIScrollEvent(
            availableEventNames[_reactEventName],
            prevProps[_reactEventName],
            nextProps[_reactEventName],
          );
        }
      },
