...
const Input = (props: InputProps) => {
  ...
  const eyeClasses = classNames('Input__content-eye', {
    [`ListInput__content-eye_state_on`]: isEyeOn === true,
  });

  const verifycodeClasses = classNames('Input__link-text', {
    [`am-color-black1`]: isSent === true,
    [`am-color-blue`]: isSent === false,
  });

  const iconClasses = classNames('Input__content', {
    [`Input__content_state_hasicon`]: icon !== undefined,
  });
    ...
    <div className={classes}>
      ...
      <span className={iconClasses}>
        ...
        <a
          ...
          className={'Input__content-clear' + ' ' + (isShowClear ? 'am-show' : 'am-hide')}
        />
        <input
          maxLength={length}
          disabled={disabled}
